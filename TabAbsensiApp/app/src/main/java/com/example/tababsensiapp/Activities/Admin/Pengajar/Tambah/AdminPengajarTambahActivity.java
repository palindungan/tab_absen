package com.example.tababsensiapp.Activities.Admin.Pengajar.Tambah;
...
import com.example.tababsensiapp.Activities.Admin.Pengajar.Tambah.presenter.AdminPengajarTambahPresenter;
import com.example.tababsensiapp.Activities.Admin.Pengajar.Tambah.presenter.IAdminPengajarTambahPresenter;
...
public class AdminPengajarTambahActivity extends AppCompatActivity implements View.OnClickListener, IAdminPengajarTambahView {

    IAdminPengajarTambahPresenter adminPengajarTambahPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_pengajar_tambah);

        adminPengajarTambahPresenter = new AdminPengajarTambahPresenter(this, this);
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        try {
                            ...
                            if (!isEmpty && !isInvalidKonfirmasi) {
                                adminPengajarTambahPresenter.onSubmit(inputNama, inputUsername, inputPassword, inputAlamat, inputNo_hp, inputFoto);
                            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            data_photo = adminPengajarTambahPresenter.getStringImage(bitmap);
        }
    }
}
