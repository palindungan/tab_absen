package com.example.tababsensiapp.Activities.Admin.Pengajar.Edit;
...
import com.example.tababsensiapp.Activities.Admin.Pengajar.Edit.presenter.AdminPengajarEditPresenter;
import com.example.tababsensiapp.Activities.Admin.Pengajar.Edit.presenter.IAdminPengajarEditPresenter;
...
public class AdminPengajarEditActivity extends AppCompatActivity implements View.OnClickListener, IAdminPengajarEditView {

    IAdminPengajarEditPresenter adminPengajarEditPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_pengajar_edit);
        ...
        adminPengajarEditPresenter = new AdminPengajarEditPresenter(this, this);
        id_pengajar = getIntent().getStringExtra(EXTRA_ID_PENGAJAR);
        adminPengajarEditPresenter.inisiasiAwal(id_pengajar);
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        try {
                            ...
                            if (!isEmpty && !isInvalidKonfirmasi) {
                                adminPengajarEditPresenter.onUpdate(id_pengajar, inputNama, inputUsername, inputPassword, inputAlamat, inputNo_hp, inputFoto);
                            }
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        try {
                            adminPengajarEditPresenter.hapusAkun(id_pengajar);
                        } catch (Exception e) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            data_photo = adminPengajarEditPresenter.getStringImage(bitmap);
        }
    }
