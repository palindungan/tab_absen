package com.example.tababsensiapp.Activities.Pengajar.Riwayat.Absen;
...
import com.example.tababsensiapp.Activities.Pengajar.Riwayat.Absen.presenter.IPengajarRiwayatAbsenPresenter;
import com.example.tababsensiapp.Activities.Pengajar.Riwayat.Absen.presenter.PengajarRiwayatAbsenPresenter;
...
public class PengajarRiwayatAbsenActivity extends AppCompatActivity implements View.OnClickListener, IPengajarRiwayatAbsenView {

    SessionManager sessionManager;
    String id_pengajar;

    IPengajarRiwayatAbsenPresenter pengajarRiwayatAbsenPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengajar_riwayat_absen);

        id_pengajar = getIntent().getStringExtra(EXTRA_ID_PENGAJAR);

        pengajarRiwayatAbsenPresenter = new PengajarRiwayatAbsenPresenter(this,this);
        pengajarRiwayatAbsenPresenter.inisiasiAwal(id_pengajar);
